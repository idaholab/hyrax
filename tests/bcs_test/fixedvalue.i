#This simulation is in 1D to show Dirichlet BCs on concentration.
...
[BCs]
  [./right_fixed_mu]
    type = DirichletBC
    variable = mu
    value = -3.87938 #this is the chemical potential mu when X=0.02
    boundary = right
  [../]
  [./right_fixed_c]
    type = DirichletBC
    variable = concentration
    value = 0.02  #forcing the concentration to be 0.02 at this boundary
    boundary = right
  [../]
[]
